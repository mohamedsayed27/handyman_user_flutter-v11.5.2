      ...
      body: Stack(
        ...
        children: [
          ...
          Column(
            ...
            children: [
              Image.asset(appLogo, height: 160, width: 160),
              32.height,
              Text(APP_NAME, style: TextStyle(fontSize: 18, color: appStore.isDarkMode ? Colors.white : Colors.black,fontWeight: FontWeight.bold), textAlign: TextAlign.center),
              8.height,
              Text(APP_SUB_NAME, style: TextStyle(fontSize: 16, color: appStore.isDarkMode ? Colors.white : Colors.black,fontWeight: FontWeight.normal), textAlign: TextAlign.center),
              16.height,
              if (appNotSynced)
                Observer(
